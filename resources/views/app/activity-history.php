...
<head>
  ...
  <title>SugarCare | Histórico de actividad</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Histórico de actividad</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="table" class="table table-bordered table-striped">
                  ...
                  $query = "SELECT fecha, hora, tiempo, actividad, observaciones  FROM registro_actividad WHERE usuario = '".$_SESSION["id"]."';";
                  try { 
