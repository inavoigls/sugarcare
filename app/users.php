          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><a href="newuser.php">Nuevo Usuario</a></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  $query = "SELECT * FROM usuarios as u INNER JOIN grupos_usuarios as gu on gu.id = u.grupo";
                  try { 
